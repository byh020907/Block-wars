...
public class UI_FollowMiniMap extends UI_MiniMap{
	
	Player user;

	public UI_FollowMiniMap(Image image, int x, int y, int width, int height,Player user) {
	...
	public Point calculateMiniMapPosition(double x,double y){
		double xp=(x-user.x)*scale+this.x+this.width/2;
		double yp=(y-user.y)*scale+this.y+this.height/2;
